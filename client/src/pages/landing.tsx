...
export default function Landing() {
  ...
  return (
    <div className={`min-h-screen transition-opacity duration-1000 ${contentVisible ? 'opacity-100' : 'opacity-0'}`}>
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 w-full border-b border-white/10 bg-background/20 backdrop-blur-md" style={{ paddingTop: 'env(safe-area-inset-top)' }}>
